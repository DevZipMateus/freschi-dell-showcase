...
const Hero = () => {
  const features = [
    ...
    { icon: TrendingUp, text: 'Resultados Garantidos' },
  ];
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-40 right-20 w-32 h-32 bg-white/50 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-40 left-20 w-16 h-16 bg-white/75 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
              ...
              <div className="space-y-6">
                <div className="text-center">
                  <img 
                    ...
                    alt="Logo Freschi & Dell Contabilidade" 
